 ...
 * Generated at: 2021-01-15 08:34:41 UTC
...
Product product = productList.get(i); 
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"product__price\"></div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"product__price\">");
      out.print(Formatter.getCurrency(product.getPrice()) );
      out.write("</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/shop/product/detail?product_id=");
      out.print(product.getProduct_id());
      out.write("\">상품 상세보기</a></li>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t");
...
if((pager.getFirstPage()-1)>=1){ 
      out.write("\n");
      out.write("\t\t\t\t<a href = \"/shop/product/list?currentPage=");
