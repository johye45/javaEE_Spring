 ...
 * Generated at: 2021-01-16 12:58:52 UTC
...
if(session.getAttribute("member")==null){ 
      ...
      out.write("         \t\t\t<h5 style=\"text-align:center\">회원가입을 축하드립니다</h5>\n");
      out.write("         \t\t\t\t<div class=\"row\">\n");
      out.write("         \t\t\t\t\t<div class=\"col-lg-12\">\n");
      out.write("         \t\t\t\t\t\t<div class=\"checkout__form__input\">\n");
      out.write("                     \t\t\t\t<p style=\"text-align:center\">\n");
      out.write("                     \t\t\t\t\t<span>이메일</span>로 회원가입메일이 발송이 되었습니다.<br>\n");
      out.write("                     \t\t\t\t\t고객님의 사이트 이용에 불편하지 않도록 노력하겠습니다.<br>\n");
      out.write("                     \t\t\t\t\t로그인 후 바로 서비스 이용이 가능합니다.<br>\n");
      out.write("                     \t\t\t\t\t아래버튼을 선택해주세요.<br>\n");
      out.write("                     \t\t\t\t</p>                       \n");
      out.write("                 \t\t\t\t</div>\n");
      out.write("         \t\t\t\t\t</div>\t \t\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("                           \t<a href=\"/\"><input type=\"button\" class=\"site-btn\" id=\"home_btn\" value=\"홈으로 이동\" ></a>\n");
      out.write("                           \t<a href=\"/shop/member/loginForm\"><input type=\"button\" class=\"site-btn\" id=\"login_btn\" value=\"로그인\"></a>\n");
      out.write("                    \t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</form>\n");
