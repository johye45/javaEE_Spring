 ...
 * Generated at: 2021-01-16 13:08:28 UTC
...
public final class forgot_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("// \t\tconsole.log($(\"#m_name\").val());\r\n");
      out.write("// \t\tconsole.log($(\"#phone\").val());\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#m_name\").val(\"\"); \r\n");
      out.write("\t\t$(\"#phone\").val(\"\");  \r\n");
      out.write("\t\t$(\"#idList\").empty();\r\n");
      out.write("\t\t$(\"#user_id\").val(\"\"); \r\n");
      out.write("\t\t$(\"#email_id\").val(\"\");  \r\n");
      out.write("\t\t$(\"#email_server\").val(\"select\");\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t})\r\n");
      out.write("})\r\n");
      out.write("$(document).on('click','#idBtn',function(){\r\n");
      out.write(" \t\tvar user_name = $('#m_name').val();\r\n");
      out.write("  \tvar user_phone = $('#phone').val();\r\n");
      out.write(" \tvar postData = {'name' : user_name , 'phone' : user_phone};\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("        url:' /shop/member/forgot_id',\r\n");
      out.write("        type:'POST',\r\n");
      out.write("        data: postData,\r\n");
      out.write("        contentType: \"application/x-www-form-urlencoded; charset=UTF-8\",\r\n");
      out.write("        dataType : \"json\",\r\n");
      out.write("        success:function(data){\r\n");
      out.write("        \tvar idLists = data.user_id;\r\n");
      out.write("        \tvar idLength = idLists.length\r\n");
      out.write("        \tvar idfind = idLists.substring(1, idLength-1)\r\n");
      out.write("       \t \t\t $(\"#idList\").html(\"<p>\"+\"회원님의 정보로 등록된 아이디는 : <br>\"+idfind+\" 입니다.</p>\")\r\n");
      out.write("        },\r\n");
      out.write("        error: function (XMLHttpRequest, textStatus, errorThrown){\r\n");
      out.write("        \talert('등록된 정보를 찾을 수 없습니다.' );\r\n");
      out.write("        }\r\n");
      out.write("    });\r\n");
      out.write("});\r\n");
      out.write("$(document).on('click','#pwdBtn',function(){\r\n");
      out.write("\t\tconsole.log($(\"#user_id\").val());\r\n");
      out.write("\t\tconsole.log($(\"#email_id\").val());\r\n");
      out.write("\t\tconsole.log($(\"#email_server\").val());\r\n");
      out.write("\t\tvar formData = $(\"#pwd_form\").serialize(); //전부 문자열화 시킨다!!\r\n");
      out.write(" \t$.ajax({\r\n");
      out.write("\t\turl:\"/shop/member/forgot_pwd\",\r\n");
      out.write("\t\ttype:\"post\",\r\n");
...
if(session.getAttribute("member")==null){ 
      ...
      out.write("\t\t<div class=\"container\" >\r\n");
      out.write("\t\t\t<form class=\"checkout__form\" id=\"login_form\">\r\n");
      out.write("\t\t\t\t<div class=\"row\" >\r\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-6\" style=\"margin:0 auto;\">\r\n");
      out.write("\t\t\t\t\t\t<ul class=\"tabs\">\r\n");
      out.write("\t\t\t\t\t\t\t<li class=\"tab-link current\" data-tab=\"tab-1\">아이디 찾기</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li class=\"tab-link\" data-tab=\"tab-2\">비밀번호 찾기</li>\r\n");
      out.write("\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-12\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"name\" id=\"m_name\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>                  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"checkout__form__input\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>등록된 휴대폰<span>*</span></p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"phone\" id=\"phone\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div style=\"text-align: center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"site-btn\" value=\"찾기\"   id=\"idBtn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span id=\"idList\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<form id=\"pwd_form\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"checkout__form__input\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>아이디<span>*</span></p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"user_id\" id=\"user_id\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>등록된 이메일주소<span>*</span></p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"checkout__form__input\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"email_id\" style=\"display: inline-block; width:55%\" id=\"email_id\">  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t @ <select name=\"email_server\" style=\"display: inline-block; width:40%\" id=\"email_server\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div style=\"text-align: center\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"site-btn\" value=\"찾기\"  id=\"pwdBtn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
