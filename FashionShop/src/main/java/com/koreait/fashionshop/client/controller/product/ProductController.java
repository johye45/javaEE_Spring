...
public class ProductController implements ServletContextAware{
	...
	*/
	...
	//엑셀파일 업로드 예외처리
	@ExceptionHandler(UploadFailException.class) //예외처리를 하기 위해서
	@ResponseBody//페이지 응답이 아닌 텍스트 응답
	...
	public ModelAndView getShopProductList(int subcategory_id,HttpServletRequest request) {//하위카테고리의 id
